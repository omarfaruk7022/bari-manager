...
const ENCRYPTION_KEY = () => {
  const k = process.env.CONFIG_ENCRYPTION_KEY || process.env.JWT_SECRET || 'default_key_change_in_prod'
...
const configSchema = new mongoose.Schema({
  ...
  category:  { type: String, enum: ['smtp', 'sms', 'payment', 'app', 'security', 'other'], default: 'other' },
  label:     { type: String },
